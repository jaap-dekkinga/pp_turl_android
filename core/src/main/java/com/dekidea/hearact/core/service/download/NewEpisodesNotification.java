...
public class NewEpisodesNotification {
    ...
    private static final String GROUP_KEY = "com.dekidea.hearact.EPISODES";
    ...
    private static void showNotification(int newEpisodes, Feed feed, Context context,
        ...
        intent.setComponent(new ComponentName(context, "com.dekidea.hearact.activity.MainActivity"));
