...
import com.dekidea.hearact.event.playback.PlaybackPositionEvent;
import com.dekidea.hearact.event.playback.PlaybackServiceEvent;
import com.dekidea.hearact.event.playback.SleepTimerUpdatedEvent;
import com.dekidea.hearact.event.settings.SkipIntroEndingChangedEvent;
import com.dekidea.hearact.event.settings.SpeedPresetChangedEvent;
import com.dekidea.hearact.event.settings.VolumeAdaptionChangedEvent;
...
import com.dekidea.hearact.playback.cast.CastPsmp;
import com.dekidea.hearact.playback.cast.CastStateListener;
import com.dekidea.hearact.ui.appstartintent.MainActivityStarter;
import com.dekidea.hearact.ui.appstartintent.VideoPlayerActivityStarter;
...
import com.dekidea.hearact.core.R;
...
import com.dekidea.hearact.core.storage.FeedSearcher;
import com.dekidea.hearact.core.sync.queue.SynchronizationQueueSink;
...
import com.dekidea.hearact.core.widget.WidgetUpdater;
...
public class PlaybackService extends MediaBrowserServiceCompat implements Constants {
    ...
    public static final String EXTRA_ALLOW_STREAM_THIS_TIME = "extra.com.dekidea.hearact.core.service.allowStream";
    public static final String EXTRA_ALLOW_STREAM_ALWAYS = "extra.com.dekidea.hearact.core.service.allowStreamAlways";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.com.dekidea.hearact.core.service.playerStatusChanged";
    private static final String AVRCP_ACTION_PLAYER_STATUS_CHANGED = "com.android.music.playstatechanged";
    private static final String AVRCP_ACTION_META_CHANGED = "com.android.music.metachanged";

    public static final String ACTION_PLAYER_NOTIFICATION = "action.com.dekidea.hearact.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.com.dekidea.hearact.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.com.dekidea.hearact.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.com.dekidea.hearact.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.com.dekidea.hearact.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.com.dekidea.hearact.core.service.pausePlayCurrentEpisode";

    /**
     * Custom action used by Android Wear, Android Auto
     */
    private static final String CUSTOM_ACTION_FAST_FORWARD = "action.com.dekidea.hearact.core.service.fastForward";
    private static final String CUSTOM_ACTION_REWIND = "action.com.dekidea.hearact.core.service.rewind";
