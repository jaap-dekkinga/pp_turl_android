package com.dekidea.hearact.core.preferences;
...
public class PlaybackPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     * object.
     */
    private static final String PREF_CURRENTLY_PLAYING_FEED_ID = "com.dekidea.hearact.preferences.lastPlayedFeedId";
    ...
    private static final String PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID
            = "com.dekidea.hearact.preferences.lastPlayedFeedMediaId";
    ...
    private static final String PREF_CURRENTLY_PLAYING_MEDIA_TYPE
            = "com.dekidea.hearact.preferences.currentlyPlayingMedia";

    /**
     * True if last played media was a video.
     */
    private static final String PREF_CURRENT_EPISODE_IS_VIDEO = "com.dekidea.hearact.preferences.lastIsVideo";

    /**
     * The current player status as int.
     */
    private static final String PREF_CURRENT_PLAYER_STATUS = "com.dekidea.hearact.preferences.currentPlayerStatus";
    ...
    private static final String PREF_CURRENTLY_PLAYING_TEMPORARY_PLAYBACK_SPEED
            = "com.dekidea.hearact.preferences.temporaryPlaybackSpeed";
