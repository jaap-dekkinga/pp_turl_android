...
public class SynchronizationCredentials {
    ...
    private static final String PREF_USERNAME = "com.dekidea.hearact.preferences.gpoddernet.username";
    private static final String PREF_PASSWORD = "com.dekidea.hearact.preferences.gpoddernet.password";
    private static final String PREF_DEVICEID = "com.dekidea.hearact.preferences.gpoddernet.deviceID";
