...
public class NewEpisodesNotification {
    ...
    private static final String GROUP_KEY = "com.tuneurl.podcastplayer.EPISODES";
    ...
    private static void showNotification(int newEpisodes, Feed feed, Context context,
        ...
        intent.setComponent(new ComponentName(context, "com.tuneurl.podcastplayer.activity.MainActivity"));
