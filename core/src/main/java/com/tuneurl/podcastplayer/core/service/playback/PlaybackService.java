...
import com.tuneurl.podcastplayer.event.playback.SleepTimerUpdatedEvent;
import com.tuneurl.podcastplayer.event.settings.SkipIntroEndingChangedEvent;
import com.tuneurl.podcastplayer.event.settings.SpeedPresetChangedEvent;
import com.tuneurl.podcastplayer.event.settings.VolumeAdaptionChangedEvent;
...
import com.tuneurl.podcastplayer.playback.cast.CastPsmp;
import com.tuneurl.podcastplayer.playback.cast.CastStateListener;
import com.tuneurl.podcastplayer.ui.appstartintent.MainActivityStarter;
import com.tuneurl.podcastplayer.ui.appstartintent.VideoPlayerActivityStarter;
...
import com.tuneurl.podcastplayer.core.R;
...
import com.tuneurl.podcastplayer.core.storage.FeedSearcher;
...
import com.tuneurl.podcastplayer.core.util.playback.PlayableUtils;
import com.tuneurl.podcastplayer.core.util.playback.PlaybackServiceStarter;
import com.tuneurl.podcastplayer.core.widget.WidgetUpdater;
...
public class PlaybackService extends MediaBrowserServiceCompat {
    ...
    public static final String EXTRA_ALLOW_STREAM_THIS_TIME = "extra.com.tuneurl.podcastplayer.core.service.allowStream";
    public static final String EXTRA_ALLOW_STREAM_ALWAYS = "extra.com.tuneurl.podcastplayer.core.service.allowStreamAlways";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.com.tuneurl.podcastplayer.core.service.playerStatusChanged";
    private static final String AVRCP_ACTION_PLAYER_STATUS_CHANGED = "com.android.music.playstatechanged";
    private static final String AVRCP_ACTION_META_CHANGED = "com.android.music.metachanged";

    public static final String ACTION_PLAYER_NOTIFICATION = "action.com.tuneurl.podcastplayer.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.com.tuneurl.podcastplayer.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.com.tuneurl.podcastplayer.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.com.tuneurl.podcastplayer.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.com.tuneurl.podcastplayer.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.com.tuneurl.podcastplayer.core.service.pausePlayCurrentEpisode";

    /**
     * Custom action used by Android Wear, Android Auto
     */
    private static final String CUSTOM_ACTION_FAST_FORWARD = "action.com.tuneurl.podcastplayer.core.service.fastForward";
    private static final String CUSTOM_ACTION_REWIND = "action.com.tuneurl.podcastplayer.core.service.rewind";
