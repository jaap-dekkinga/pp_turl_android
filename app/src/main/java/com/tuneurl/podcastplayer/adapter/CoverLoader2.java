...
import com.tuneurl.podcastplayer.core.glide.PaletteBitmap;
...
public class CoverLoader2 {
    ...
    public CoverLoader2(MainActivity2 activity) {
        this.activity = activity;
    }

    public CoverLoader2 withUri(String uri) {
        this.uri = uri;
        return this;
    }

    public CoverLoader2 withResource(int resource) {
        this.resource = resource;
        return this;
    }

    public CoverLoader2 withFallbackUri(String uri) {
        fallbackUri = uri;
        return this;
    }

    public CoverLoader2 withCoverView(ImageView coverView) {
        imgvCover = coverView;
        return this;
    }

    public CoverLoader2 withPlaceholderView(TextView placeholderView) {
     ...
     */
    @NonNull
    public CoverLoader2 withPlaceholderView(@NonNull TextView placeholderView, boolean textAndImageCombined) {
