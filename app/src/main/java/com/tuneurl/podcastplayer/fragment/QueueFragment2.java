...
import com.tuneurl.podcastplayer.adapter.QueueRecyclerAdapter2;
 ...
 */
public class QueueFragment2 extends Fragment implements EpisodeItemListAdapter2.OnSelectModeListener {
    public static final String TAG = "QueueFragment";
    private static final String KEY_UP_ARROW = "up_arrow";

    private TextView infoBar;
    private EpisodeItemListRecyclerView recyclerView;
    private QueueRecyclerAdapter2 recyclerAdapter;
    ...
    private SwipeActions2 swipeActions;
    ...
    public void onPause() {
        super.onPause();
        recyclerView.saveScrollPosition(QueueFragment2.TAG);
    }
    ...
    private void setQueueLocked(boolean locked) {
        ...
        if (queue.size() == 0) {
            if (locked) {
                ((MainActivity2) getActivity()).showSnackbarAbovePlayer(R.string.queue_locked, Snackbar.LENGTH_SHORT);
            } else {
                ((MainActivity2) getActivity()).showSnackbarAbovePlayer(R.string.queue_unlocked, Snackbar.LENGTH_SHORT);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.queue_fragment2, container, false);
        
        ((MainActivity2) getActivity()).setSelectedFragmentTitle(getString(R.string.bookmarks));
        ...
        recyclerView.setRecycledViewPool(((MainActivity2) getActivity()).getRecycledViewPool());
    ...
    private void onFragmentLoaded(final boolean restoreScrollPosition) {
        ...
        if (queue != null) {
            ...
            if (recyclerAdapter == null) {
                ...
                recyclerAdapter = new QueueRecyclerAdapter2(activity, swipeActions) {

                    @Override
                    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                        super.onCreateContextMenu(menu, v, menuInfo);
                        MenuItemUtils.setOnClickListeners(menu, QueueFragment2.this::onContextItemSelected);
                    }
                };
        ...
        if (restoreScrollPosition) {
            recyclerView.restoreScrollPosition(QueueFragment2.TAG);
        }
    ...
    private class QueueSwipeActions extends SwipeActions2 {
        ...
        public QueueSwipeActions() {
            super(ItemTouchHelper.UP | ItemTouchHelper.DOWN, QueueFragment2.this, TAG);
        }
