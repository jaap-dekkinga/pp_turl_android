 ...
 */
public class CompletedDownloadsFragment2 extends Fragment
        implements EpisodeItemListAdapter2.OnSelectModeListener, Toolbar.OnMenuItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.simple_list_fragment2, container, false);

        displayUpArrow = getParentFragmentManager().getBackStackEntryCount() != 0;
        if (savedInstanceState != null) {
            displayUpArrow = savedInstanceState.getBoolean(KEY_UP_ARROW);
        }
        //((MainActivity2) getActivity()).setupToolbarToggle(toolbar, displayUpArrow);
        ((MainActivity2) getActivity()).setSelectedFragmentTitle(getString(R.string.downloaded));

        recyclerView = root.findViewById(R.id.recyclerView);
        recyclerView.setRecycledViewPool(((MainActivity2) getActivity()).getRecycledViewPool());
        adapter = new CompletedDownloadsListAdapter((MainActivity2) getActivity());
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.refresh_item) {
            ...
            ((MainActivity2) getActivity()).loadChildFragment(SearchFragment2.newInstance());
            return true;
        }
        return false;
    }
    ...
    private class CompletedDownloadsListAdapter extends EpisodeItemListAdapter2 {

        public CompletedDownloadsListAdapter(MainActivity2 mainActivity) {
            super(mainActivity);
        }

        @Override
        public void afterBindViewHolder(EpisodeItemViewHolder2 holder, int pos) {
            if (!inActionMode()) {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            MenuItemUtils.setOnClickListeners(menu, CompletedDownloadsFragment2.this::onContextItemSelected);
        }
    }
}
