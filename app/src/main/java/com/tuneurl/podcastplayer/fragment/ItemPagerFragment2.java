 ...
 */
public class ItemPagerFragment2 extends Fragment implements Toolbar.OnMenuItemClickListener {
    ...
    /**
     * Creates a new instance of an ItemPagerFragment2.
     *
     ...
     */
    public static ItemPagerFragment2 newInstance(long[] feeditems, int feedItemPos) {
        ItemPagerFragment2 fragment = new ItemPagerFragment2();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (savedInstanceState != null && savedInstanceState.getInt(KEY_PAGER_ID, 0) != 0) {
            // Restore state by using the same ID as before. ID collisions are prevented in MainActivity2.
    ...
    private class ItemPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            return ItemFragment2.newInstance(feedItems[position]);
        }
