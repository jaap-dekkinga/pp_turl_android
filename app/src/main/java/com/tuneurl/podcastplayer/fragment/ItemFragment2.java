...
import com.tuneurl.podcastplayer.adapter.actionbutton.CancelDownloadActionButton;
...
import com.tuneurl.podcastplayer.adapter.actionbutton.MarkAsPlayedActionButton;
import com.tuneurl.podcastplayer.adapter.actionbutton.PauseActionButton;
import com.tuneurl.podcastplayer.adapter.actionbutton.PlayActionButton;
import com.tuneurl.podcastplayer.adapter.actionbutton.PlayLocalActionButton;
import com.tuneurl.podcastplayer.adapter.actionbutton.StreamActionButton;
import com.tuneurl.podcastplayer.adapter.actionbutton.VisitWebsiteActionButton;
...
import com.tuneurl.podcastplayer.core.util.DateFormatter;
...
import com.tuneurl.podcastplayer.core.util.playback.Timeline;
...
import com.tuneurl.podcastplayer.view.ShownotesWebView;
...
public class ItemFragment2 extends Fragment {
    ...
    private static final String TAG = "ItemFragment2";
    private static final String ARG_FEEDITEM = "feeditem";

    /**
     * Creates a new instance of an ItemFragment2
     *
     * @param feeditem The ID of the FeedItem to show
     * @return The ItemFragment2 instance
     */
    public static ItemFragment2 newInstance(long feeditem) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        webvDescription.setTimecodeSelectedListener(time -> {
            if (controller != null && item.getMedia() != null && controller.getMedia() != null
                ...
                ((MainActivity2) getActivity()).showSnackbarAbovePlayer(R.string.play_this_to_seek_position,
    ...
    private void openPodcast() {
        Fragment fragment = FeedItemlistFragment2.newInstance(item.getFeedId());
        ((MainActivity2) getActivity()).loadChildFragment(fragment);
    }
