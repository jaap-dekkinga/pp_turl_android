...
import com.tuneurl.podcastplayer.adapter.FeedSearchResultAdapter2;
...
public class SearchFragment2 extends Fragment {
    ...
    private EpisodeItemListAdapter2 adapter;
    private FeedSearchResultAdapter2 adapterFeeds;
    ...
    /**
     * Create a new SearchFragment2 that searches all feeds.
     */
    ...
    /**
     * Create a new SearchFragment2 that searches all feeds with pre-defined query.
     */
    public static SearchFragment2 newInstance(String query) {
        SearchFragment2 fragment = newInstance();
        fragment.getArguments().putString(ARG_QUERY, query);
        return fragment;
    }

    /**
     * Create a new SearchFragment2 that searches one specific feed.
     */
    public static SearchFragment2 newInstance(long feed, String feedTitle) {
        SearchFragment2 fragment = newInstance();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        adapter = new EpisodeItemListAdapter2((MainActivity2) getActivity()) {
            @Override
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                super.onCreateContextMenu(menu, v, menuInfo);
                MenuItemUtils.setOnClickListeners(menu, SearchFragment2.this::onContextItemSelected);
            }
        };
        ...
        adapterFeeds = new FeedSearchResultAdapter2((MainActivity2) getActivity());
