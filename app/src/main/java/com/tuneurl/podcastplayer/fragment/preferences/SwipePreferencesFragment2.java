...
public class SwipePreferencesFragment2 extends PreferenceFragmentCompat {
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity2) getActivity()).getSupportActionBar().setTitle(R.string.swipeactions_label);
    }
