...
import com.tuneurl.podcastplayer.core.export.opml.OpmlWriter;
import com.tuneurl.podcastplayer.core.storage.DatabaseExporter;
...
public class ImportExportPreferencesFragment2 extends PreferenceFragmentCompat {
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity2) getActivity()).getSupportActionBar().setTitle(R.string.import_export_pref);
    }
