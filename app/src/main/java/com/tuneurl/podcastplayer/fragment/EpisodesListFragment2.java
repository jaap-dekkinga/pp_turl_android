 ...
 */
public abstract class EpisodesListFragment2 extends Fragment implements EpisodeItemListAdapter2.OnSelectModeListener {
    ...
    EpisodeItemListAdapter2 listAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.all_episodes_fragment2, container, false);
    ...
    private void performMultiSelectAction(int actionItemId) {
        EpisodeMultiSelectActionHandler2 handler =
                new EpisodeMultiSelectActionHandler2(((MainActivity2) getActivity()), actionItemId);
    ...
    private void createRecycleAdapter(RecyclerView recyclerView, EmptyViewHandler emptyViewHandler) {
        ...
        listAdapter = new EpisodeItemListAdapter2(mainActivity) {
            @Override
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                ...
                MenuItemUtils.setOnClickListeners(menu, EpisodesListFragment2.this::onContextItemSelected);
            }
        };
