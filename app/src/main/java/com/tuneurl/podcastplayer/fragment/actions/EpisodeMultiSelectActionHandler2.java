package com.tuneurl.podcastplayer.fragment.actions;
...
public class EpisodeMultiSelectActionHandler2 {
    ...
    public EpisodeMultiSelectActionHandler2(MainActivity2 activity, int actionId) {
