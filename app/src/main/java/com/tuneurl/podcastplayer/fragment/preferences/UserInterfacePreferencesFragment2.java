...
public class UserInterfacePreferencesFragment2 extends PreferenceFragmentCompat {
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity2) getActivity()).getSupportActionBar().setTitle(R.string.user_interface_label);
    }
    ...
    private void setupInterfaceScreen() {
        ...
        findPreference(PREF_SWIPE)
                .setOnPreferenceClickListener(preference -> {
                    ((MainActivity2) getActivity()).openScreen(R.xml.preferences_swipe);
                    return true;
                });
