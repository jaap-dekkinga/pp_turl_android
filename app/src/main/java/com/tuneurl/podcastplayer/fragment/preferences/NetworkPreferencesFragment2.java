...
public class NetworkPreferencesFragment2 extends PreferenceFragmentCompat
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity2) getActivity()).getSupportActionBar().setTitle(R.string.network_pref);
    ...
    private void setupNetworkScreen() {
        findPreference(PREF_SCREEN_AUTODL).setOnPreferenceClickListener(preference -> {
            ((MainActivity2) getActivity()).openScreen(R.xml.preferences_autodownload);
            return true;
        });
