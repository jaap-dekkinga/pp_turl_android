...
public class SwipeActions2 extends ItemTouchHelper.SimpleCallback implements LifecycleObserver {
    ...
    public SwipeActions2(int dragDirs, Fragment fragment, String tag) {
    ...
    public SwipeActions2(Fragment fragment, String tag) {
        this(0, fragment, tag);
    }
    ...
    public SwipeActions2 attachTo(RecyclerView recyclerView) {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int swipeDir) {
        ...
        FeedItem item = ((EpisodeItemViewHolder2) viewHolder).getFeedItem();
    ...
    public void startDrag(EpisodeItemViewHolder2 holder) {
