...
public class NotificationPreferencesFragment2 extends PreferenceFragmentCompat {
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity2) getActivity()).getSupportActionBar().setTitle(R.string.notification_pref_fragment);
    }
