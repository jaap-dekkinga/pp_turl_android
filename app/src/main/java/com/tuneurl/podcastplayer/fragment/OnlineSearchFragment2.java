...
public class OnlineSearchFragment2 extends Fragment {
    ...
    public static OnlineSearchFragment2 newInstance(Class<? extends PodcastSearcher> searchProvider) {
        return newInstance(searchProvider, null);
    }

    public static OnlineSearchFragment2 newInstance(Class<? extends PodcastSearcher> searchProvider, String query) {
        OnlineSearchFragment2 fragment = new OnlineSearchFragment2();
