...
public class AutoDownloadPreferencesFragment2 extends PreferenceFragmentCompat {
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity2) getActivity()).getSupportActionBar().setTitle(R.string.pref_automatic_download_title);
    }
