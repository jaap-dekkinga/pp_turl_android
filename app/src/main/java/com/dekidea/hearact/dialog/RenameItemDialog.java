...
import com.dekidea.hearact.databinding.EditTextDialogBinding;
...
public class RenameItemDialog {
    ...
    public void show() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(activity)
                ...
                .setNeutralButton(com.dekidea.hearact.core.R.string.reset, null)
                .setNegativeButton(com.dekidea.hearact.core.R.string.cancel_label, null)
                .show();
