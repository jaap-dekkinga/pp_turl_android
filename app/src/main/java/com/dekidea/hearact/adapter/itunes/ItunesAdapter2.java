package com.dekidea.hearact.adapter.itunes;
...
public class ItunesAdapter2 extends ArrayAdapter<PodcastSearchResult> {
    /**
     * Related Context
     */
     ...
     */
    public ItunesAdapter2(Context context, List<PodcastSearchResult> objects) {
