package com.dekidea.hearact.preferences;
    ...
    private static void upgrade(int oldVersion, Context context) {
        ...
        if (oldVersion < 1070400) {
            ...
            if (!prefs.contains(UserPreferences.PREF_ENQUEUE_LOCATION)) {
                ...
                UserPreferences.EnqueueLocation enqueueLocation = enqueueAtFront ? UserPreferences.EnqueueLocation.FRONT : UserPreferences.EnqueueLocation.BACK;
